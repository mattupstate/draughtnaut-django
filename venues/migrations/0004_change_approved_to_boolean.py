...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Venue.date_approved'
        db.delete_column('venues_venue', 'date_approved')

        # Adding field 'Venue.approved'
        db.add_column('venues_venue', 'approved', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Venue.date_approved'
        db.add_column('venues_venue', 'date_approved', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Deleting field 'Venue.approved'
        db.delete_column('venues_venue', 'approved')
